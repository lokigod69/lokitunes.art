...
export function SonicOrb({ album, pushTrigger, position, radius, visualScale = 1, deviceTier, isMobile = false, onHover, onNavigate, onRegisterRigidBody, resetTrigger, orbIndex = 0, allBodiesRef }: OrbProps) {
  ...
  return (
    <RigidBody
      ...
      angularDamping={isMobile ? 0.5 : 0.55}      // Match BubbleOrb/VersionOrb (was 0.3)
